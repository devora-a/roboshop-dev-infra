...
# mongodb allowing connections from catalogueon port 27017
...
# mongodb allowing connections from user port 27017
...
# mongodb allowing connections from bastion port 22
